...
public class J extends FourStateThingy {
    ...
    public void generate(ArrayList<Rectangle> ra, Rectangle r) {
        ...
        ra.add(r);
        r = new Rectangle(r.x + 2 * Tetris.REC_W, r.y + Tetris.REC_W, Tetris.REC_W, Tetris.REC_W);
        ra.add(r);
    }
    ...
    public void generate1(ArrayList<Rectangle> ra, Rectangle r) {
        ...
        ra.add(r);
        r = new Rectangle(r.x + Tetris.REC_W, r.y - 2 * Tetris.REC_W, Tetris.REC_W, Tetris.REC_W);
        ra.add(r);
    }
